...
import com.amphisoft.epub.metadata.NcxTreeViewer;
...
import com.amphisoft.epub2pdf.metadata.NcxParser;
import com.amphisoft.epub2pdf.metadata.TocTree;
...
public class Converter {
	...
	public void convert(String epubPath) throws IOException,DocumentException {
		...
		NcxParser ncxParser = new NcxParser(ncx);

		TocTree tocTree = ncxParser.buildTocTree();
		new NcxTreeViewer(tocTree.getTreeModel()).launch();
